...
import com.damir.popravi.repository.JavnoPitanjeRepository;
import com.damir.popravi.repository.search.JavnoPitanjeSearchRepository;
...
/**
 * REST controller for managing {@link com.damir.popravi.domain.JavnoPitanje}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class JavnoPitanjeResource {
    ...
    public List<JavnoPitanje> getAllJavnoPitanjes() {
