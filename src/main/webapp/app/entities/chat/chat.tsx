...
export const Chat = (props: IChatProps) => {
  ...
  return (
    <div>
      <h2 id="chat-heading">
        <Translate contentKey="popraviApp.chat.home.title">Chats</Translate>
        <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
          <FontAwesomeIcon icon="plus" />
          &nbsp;
          <Translate contentKey="popraviApp.chat.home.createLabel">Create new Chat</Translate>
        </Link>
      </h2>
      <Row>
        <Col sm="12">
            ...
            <AvGroup>
              <InputGroup>
                <AvInput
                  ...
                  placeholder={translate('popraviApp.chat.home.search')}
                />
        ...
        {chatList && chatList.length > 0 ? (
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="popraviApp.chat.home.notFound">No Chats found</Translate>
            </div>
          )
        )}
      </div>
