  ...
  return (
    <div>
      <h2 id="galerija-heading">
        <Translate contentKey="popraviApp.galerija.home.title">Galerijas</Translate>
        <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
          <FontAwesomeIcon icon="plus" />
          &nbsp;
          <Translate contentKey="popraviApp.galerija.home.createLabel">Create new Galerija</Translate>
        </Link>
      </h2>
      <Row>
        <Col sm="12">
            ...
            <AvGroup>
              <InputGroup>
                <AvInput
                  ...
                  placeholder={translate('popraviApp.galerija.home.search')}
                />
        ...
        {galerijaList && galerijaList.length > 0 ? (
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="popraviApp.galerija.home.notFound">No Galerijas found</Translate>
            </div>
          )
        )}
      </div>
