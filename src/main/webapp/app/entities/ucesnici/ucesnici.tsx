  ...
  return (
    <div>
      <h2 id="ucesnici-heading">
        <Translate contentKey="popraviApp.ucesnici.home.title">Ucesnicis</Translate>
        <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
          <FontAwesomeIcon icon="plus" />
          &nbsp;
          <Translate contentKey="popraviApp.ucesnici.home.createLabel">Create new Ucesnici</Translate>
        </Link>
      </h2>
      <Row>
        <Col sm="12">
            ...
            <AvGroup>
              <InputGroup>
                <AvInput
                  ...
                  placeholder={translate('popraviApp.ucesnici.home.search')}
                />
        ...
        {ucesniciList && ucesniciList.length > 0 ? (
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="popraviApp.ucesnici.home.notFound">No Ucesnicis found</Translate>
            </div>
          )
        )}
      </div>
