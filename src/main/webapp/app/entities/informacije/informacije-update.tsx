  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="popraviApp.informacije.home.createOrEditLabel">
            <Translate contentKey="popraviApp.informacije.home.createOrEditLabel">Create or edit a Informacije</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
