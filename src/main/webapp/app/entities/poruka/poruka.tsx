  ...
  return (
    <div>
      <h2 id="poruka-heading">
        <Translate contentKey="popraviApp.poruka.home.title">Porukas</Translate>
        <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
          <FontAwesomeIcon icon="plus" />
          &nbsp;
          <Translate contentKey="popraviApp.poruka.home.createLabel">Create new Poruka</Translate>
        </Link>
      </h2>
      <Row>
        <Col sm="12">
            ...
            <AvGroup>
              <InputGroup>
                <AvInput
                  ...
                  placeholder={translate('popraviApp.poruka.home.search')}
                />
        ...
        {porukaList && porukaList.length > 0 ? (
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="popraviApp.poruka.home.notFound">No Porukas found</Translate>
            </div>
          )
        )}
      </div>
