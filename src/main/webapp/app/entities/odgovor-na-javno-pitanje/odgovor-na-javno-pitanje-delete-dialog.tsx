...
export const OdgovorNaJavnoPitanjeDeleteDialog = (props: IOdgovorNaJavnoPitanjeDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="popraviApp.odgovorNaJavnoPitanje.delete.question">
        <Translate contentKey="popraviApp.odgovorNaJavnoPitanje.delete.question" interpolate={{ id: odgovorNaJavnoPitanjeEntity.id }}>
