  ...
  return (
    <div>
      <h2 id="odgovor-na-javno-pitanje-heading">
        <Translate contentKey="popraviApp.odgovorNaJavnoPitanje.home.title">Odgovor Na Javno Pitanjes</Translate>
        <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
          <FontAwesomeIcon icon="plus" />
          &nbsp;
          <Translate contentKey="popraviApp.odgovorNaJavnoPitanje.home.createLabel">Create new Odgovor Na Javno Pitanje</Translate>
        </Link>
      </h2>
      <Row>
        <Col sm="12">
            ...
            <AvGroup>
              <InputGroup>
                <AvInput
                  ...
                  placeholder={translate('popraviApp.odgovorNaJavnoPitanje.home.search')}
                />
        ...
        {odgovorNaJavnoPitanjeList && odgovorNaJavnoPitanjeList.length > 0 ? (
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="popraviApp.odgovorNaJavnoPitanje.home.notFound">No Odgovor Na Javno Pitanjes found</Translate>
            </div>
          )
        )}
      </div>
