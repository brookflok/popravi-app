  ...
  return (
    <div>
      <h2 id="lokacija-heading">
        <Translate contentKey="popraviApp.lokacija.home.title">Lokacijas</Translate>
        <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
          <FontAwesomeIcon icon="plus" />
          &nbsp;
          <Translate contentKey="popraviApp.lokacija.home.createLabel">Create new Lokacija</Translate>
        </Link>
      </h2>
      <Row>
        <Col sm="12">
            ...
            <AvGroup>
              <InputGroup>
                <AvInput
                  ...
                  placeholder={translate('popraviApp.lokacija.home.search')}
                />
        ...
        {lokacijaList && lokacijaList.length > 0 ? (
          <Table responsive>
            <thead>
              <tr>
                ...
                <th>
                  <Translate contentKey="popraviApp.lokacija.adresa">Adresa</Translate>
                </th>
                <th>
                  <Translate contentKey="popraviApp.lokacija.postanskiBroj">Postanski Broj</Translate>
                </th>
                <th>
                  <Translate contentKey="popraviApp.lokacija.grad">Grad</Translate>
                </th>
                <th>
                  <Translate contentKey="popraviApp.lokacija.kanton">Kanton</Translate>
                </th>
                <th />
              </tr>
            </thead>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="popraviApp.lokacija.home.notFound">No Lokacijas found</Translate>
            </div>
          )
        )}
      </div>
