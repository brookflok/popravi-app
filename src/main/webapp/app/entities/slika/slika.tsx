...
export const Slika = (props: ISlikaProps) => {
  ...
  return (
    <div>
      <h2 id="slika-heading">
        <Translate contentKey="popraviApp.slika.home.title">Slikas</Translate>
        <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
          <FontAwesomeIcon icon="plus" />
          &nbsp;
          <Translate contentKey="popraviApp.slika.home.createLabel">Create new Slika</Translate>
        </Link>
      </h2>
      <Row>
        <Col sm="12">
            ...
            <AvGroup>
              <InputGroup>
                <AvInput
                  ...
                  placeholder={translate('popraviApp.slika.home.search')}
                />
        ...
        {slikaList && slikaList.length > 0 ? (
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="popraviApp.slika.home.notFound">No Slikas found</Translate>
            </div>
          )
        )}
      </div>
