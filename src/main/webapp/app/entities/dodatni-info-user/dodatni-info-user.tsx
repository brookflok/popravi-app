  ...
  return (
    <div>
      <h2 id="dodatni-info-user-heading">
        <Translate contentKey="popraviApp.dodatniInfoUser.home.title">Dodatni Info Users</Translate>
        <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
          <FontAwesomeIcon icon="plus" />
          &nbsp;
          <Translate contentKey="popraviApp.dodatniInfoUser.home.createLabel">Create new Dodatni Info User</Translate>
        </Link>
      </h2>
      <Row>
        <Col sm="12">
            ...
            <AvGroup>
              <InputGroup>
                <AvInput
                  ...
                  placeholder={translate('popraviApp.dodatniInfoUser.home.search')}
                />
        ...
        {dodatniInfoUserList && dodatniInfoUserList.length > 0 ? (
          <Table responsive>
            <thead>
              <tr>
                ...
                <th>
                  <Translate contentKey="popraviApp.dodatniInfoUser.korisnickoime">Korisnickoime</Translate>
                </th>
                <th>
                  <Translate contentKey="popraviApp.dodatniInfoUser.brojTelefona">Broj Telefona</Translate>
                </th>
                <th>
                  <Translate contentKey="popraviApp.dodatniInfoUser.majstor">Majstor</Translate>
                </th>
                <th>
                  <Translate contentKey="popraviApp.dodatniInfoUser.postoji">Postoji</Translate>
                </th>
                <th>
                  <Translate contentKey="popraviApp.dodatniInfoUser.detaljniOpis">Detaljni Opis</Translate>
                </th>
                <th>
                  <Translate contentKey="popraviApp.dodatniInfoUser.lokacija">Lokacija</Translate>
                </th>
                <th>
                  <Translate contentKey="popraviApp.dodatniInfoUser.profilnaSlika">Profilna Slika</Translate>
                </th>
                <th>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="popraviApp.dodatniInfoUser.home.notFound">No Dodatni Info Users found</Translate>
            </div>
          )
        )}
      </div>
