...
export const DodatniInfoUserDeleteDialog = (props: IDodatniInfoUserDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="popraviApp.dodatniInfoUser.delete.question">
        <Translate contentKey="popraviApp.dodatniInfoUser.delete.question" interpolate={{ id: dodatniInfoUserEntity.id }}>
