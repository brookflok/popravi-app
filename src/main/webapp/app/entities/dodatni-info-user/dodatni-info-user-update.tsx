  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="popraviApp.dodatniInfoUser.home.createOrEditLabel">
            <Translate contentKey="popraviApp.dodatniInfoUser.home.createOrEditLabel">Create or edit a DodatniInfoUser</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
